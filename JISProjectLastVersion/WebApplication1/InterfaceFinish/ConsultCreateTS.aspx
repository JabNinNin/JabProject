<%@ Page Title="" Language="C#" MasterPageFile="~/InterfaceFinish/Consult.Master" AutoEventWireup="true" CodeBehind="ConsultCreateTS.aspx.cs" Inherits="WebApplication1.InterfaceFinish.WebForm4" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <div class="sidebar-wrapper">
				...
				<ul class="nav">
    <li >
        <a href="ConsultViewTS.aspx">
            <i class="material-icons">view_agenda</i>
            <p>View TimeSheets</p>
        </a>
    </li>
    <li class="active">
        <a href="ConsultCreateTS.aspx">
	                                   ...
	                                   <div class="row">
                                           <div class="col-md-3">
                                                    <div class="form-group label-floating">
                                                        ...
                                                        <asp:DropDownList ID="DropDownList2" runat="server" Cssclass="form-control"  DataSourceID ="SqlDataSource2" DataTextField="projectname" DataValueField="projectname" >
                                                            </asp:DropDownList>
                                                            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:connectionString %>" SelectCommand="select [project].projectname from Assign 
            ...
            <script>
                ...
                $('#datepairExample02').datepair();
                                    ...
                                    <div class="row">
	                                    ...
	                                    <button type="submit" class="btn btn-primary pull-right">Add row TimeSheets</button>
